...
public class PingAnPayDemoController
{
    ...
    @GetMapping("pay2")
    public void pay2(@RequestParam("money") int money, HttpServletRequest req, HttpServletResponse resp, String data) throws Exception
    {
         ...
         * 1 data字段内容进行AES加密，再二进制转十六进制(bin2hex)
         */
        TLinx2Util.handleEncrypt(req.getParameter("data"), postmap, configParamsUtils.getPinganOpenKey().trim());
