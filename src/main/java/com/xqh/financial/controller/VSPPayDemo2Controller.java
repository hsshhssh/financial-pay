...
@RestController
@RequestMapping("vsp")
public class VSPPayDemo2Controller
{
    private static Logger logger = LoggerFactory.getLogger(VSPPayDemo2Controller.class);
                                ...
                                @RequestParam(name = "tel") String tel) throws Exception
    {
        ...
        String signStr = XmlTools.signPlain(_tempXmlStr, VSPPayDemo2Controller.class.getClassLoader().getResource("file/20058100001175504.p12").getPath(), "111111", false);
